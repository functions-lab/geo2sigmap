...
### data folder structure
    ...
    │   │   │   ├── Area_b2l_result.txt                                                # Step 1: Each line recorded the area's GPS coordinate and b2l ratio
    │   │   │   ├── Filtered_Area_b2l_result.txt                                       # Step 1: Same as above but filtered with bl2 ratio > THRESHOLD
    │   │   │   ├── OSM_download                                                       # Step 1: OSM XML file,  each .xml file for a given area
    ...
    │   │   │   │   ├── 77ecdcb3-f018-4606-81f9-5694be5ec41d                           # Step 2: Each folder for a given area   
    │   │   │   │   │   ├── meshes
    ...
    │   │   │       ├── 77ecdcb3-f018-4606-81f9-5694be5ec41d_-244_-244_21_82.npy       # Step 3: Each file for a given TX position and angle.
    │   │   │       └── ...
    │   │   └── ...
