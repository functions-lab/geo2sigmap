...
### data folder structure
    ...
    │   ├── measurement
    │   ├── generated
    │   │   ├── Jan05_1837_01b9be                                                      # Step 1 will generate a new folder each time 
    │   │   │   ├── Bl_building_npy                                                    # 2D Building Height Map
    │   │   │   ├── Bl_xml_files                                                       # 3D Building Meshs
    │   │   │   ├── OSM_download                                                       # OSM XML file
    │   │   │   ├── Jan05_1837_RXcross_TXtr38901-cross_SampleNum7e6_cmres4             # Step 3 will generate a new folder each time 
    │   │   │   │   ├── 77ecdcb3-f018-4606-81f9-5694be5ec41d_-244_-244_21_82.npy       # Signal coverage map generated by Sioona RT
    │   │   │   │   └── ...
